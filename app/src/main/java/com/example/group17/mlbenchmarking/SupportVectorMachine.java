    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SVMTrain.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                EditText param1 = (EditText) findViewById(R.id.SVMParameter1Value);
                EditText param2 = (EditText) findViewById(R.id.SVMParameter2Value);


                String c = param1.getText().toString();
                String s = param2.getText().toString();

                InputMethodManager hideKeyboard = (InputMethodManager) getSystemService(SupportVectorMachine.INPUT_METHOD_SERVICE);
                ...
                if(c.matches("")||s.matches("")) {
                    ...
                    String filecontent1 = "java -cp \"wekaSTRIPPED.jar\" weka.classifiers.functions.SMO -x "+ c +" -s " + s+ " -t \"train.arff\" -d youtube.model";
        ...
        SVMTest.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        TextView txtview = (TextView)findViewById(R.id.SVMAnswers);
                        ...
                        Classifier cls = (weka.classifiers.functions.SMO) ois.readObject();
                        ois.close();
                        ...
                        Log.d("SVM", "Current Timestamp: " + format);
                    ...
                    String filecontent2 = "Classifier Used: SVM \n"+ answer;
                    String filename="Log";
